...
function popUp(index) {
    htmls = [
        ...
        `<p>Ye dekh ye photo bhi acha hi hai waise😅cute toh lag rahi hai no 🧐 doubt🙂par khush mat ho tum sirf cute ho😅masoom ya shareef nhi 🤣shareef insaan ko dekhna hai toh aage dekho</p>`, 
